  ...
  return (
    <div className="max-w-[1300px] mx-auto px-2 sm:px-4 my-4">
      ...
      <p className="sm:text-lg lg:text-xl">
        ...
        and discuss all things anime. Whether you're into the latest series,
        classic favorites, or deep-dive discussions, you're in the right place!
        <br />
        <br />I manage everything here solo, from writing content to keeping the
        site updated with fresh recommendations and insights. If you're a fan of
        anime and want a cozy corner to indulge in anime talk, you've found your
        spot. Thanks for visiting, and I hope you enjoy the content as much as I
        enjoy creating it!
      </p>
